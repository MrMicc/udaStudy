 ...
 *************************/
//MAIN IMAGE
var HTMLmainSectionImage =
    '<picture>' +
        '<img class="col-md-12" src=%dataDesktop% alt="Main content of the portfolio">'+
    '</picture>';
var HTMLmainSectionImageMobile = '<source media="(max-width: 465px)" srcset=%dataMobile%>';
var HTMLmainSectionImagePhablet = '<source media="(max-width: 565px)" srcset=%dataPhablet%>';
var HTMLmainSectionImageTablet = '<source media="(max-width: 768px)" srcset=%dataTablet%>';

//MAIN TEXT
var HTMLmainSectionTextDiv =
